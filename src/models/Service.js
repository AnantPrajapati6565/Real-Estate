...
//   create: async (serviceData) => {
//     const { title, description, icon, features, isActive = true } = serviceData;
//     const query = `
//             INSERT INTO services (title, description, icon, features, is_active)
//             VALUES ($1, $2, $3, $4, $5)
//             RETURNING *
//         `;
//     const values = [title, description, icon, features || [], isActive];
